        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              // If the width is less than 800, switch to a vertical column layout
              if (constraints.maxWidth < 600) {
                return Column(
                  children: [
                    ...
                    buildFirstContainer(),
                    const SizedBox(
                        height: 20), // Add some spacing between containers
                ...
                // Else use the original horizontal row layout
                return Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    buildFirstContainer(),
